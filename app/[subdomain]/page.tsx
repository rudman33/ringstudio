...
export default function Page({params}:{params:Promise<{subdomain:string}>}){
  ...
  return<div style={{minHeight:'100vh',background:'#F8F3EC'}}>
    ...
    <div style={{maxWidth:660,margin:'0 auto',padding:'1.5rem 1rem 4rem'}}>
      ...
      {aiImage&&<div style={{background:W,border:'1px solid '+BDR,borderRadius:14,padding:'1rem',marginBottom:'1.25rem',textAlign:'center'}}>
        <img src={aiImage} alt="AI generated ring" style={{width:'100%',borderRadius:10,marginBottom:8}}/>
        <div style={{fontSize:11,color:INKS}}>AI-generated visualization — actual ring may vary</div>
      </div>}
